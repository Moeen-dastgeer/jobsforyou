<x-app-layout>
    <main>
        <x-front.filter :category="$category" :city="$city" :q="$q" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card rounded-0">
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-sm-9 col-12">
                                                <a href="{{ route('job', $job->slug) }}" class="text-decoration-none">
                                                    <h5 class="mt-4"><strong>{{ $job->name }} @</strong>
                                                        <span class="text-dark">{{ $job->company_name }}</span>
                                                    </h5>
                                                </a>
                                            ...
                                            <div class="col-md-2 col-sm-12 col-12 text-center">
                                                @auth
                                                    ...
                                                    @else
                                                        <a href="#"
                                                            onclick="alert('Login on candidate account for apply on jobs.')"
                                                            class="btn btn-primary px-3 mt-5">{{ __('Apply Now') }}</a>
                                                    @endif
                                                @else
                                                    <a href="{{ route('login') }}"
                                ...
                                @empty
                                    <h1 class="text-gray text-center">NOT FOUND JOBS</h1>
                                @endforelse
